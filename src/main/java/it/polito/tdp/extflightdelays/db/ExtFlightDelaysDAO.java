...
public class ExtFlightDelaysDAO {
	...
	public List<Collegamento> getFlightValidi(int x, Map<Integer, Airport> idMap) {
		...
		LinkedList<Collegamento> result = new LinkedList<>();
		...
		try {
			...
			while (rs.next()) {
				...
				if(a1!=null && a2!=null ) {
					Collegamento col = new Collegamento(a1, a2, rs.getDouble("media"));
					result.add(col);
				}
			}
